            ...
            <header class="header-area clearfix">
                ...
                <div class="cart-fav-search mb-100">
                    ...
                    <a href="Favorites.aspx" class="fav-nav">
                        <img src="../css/PageStyle/img/core-img/favorites.png" />Favoritos 
                        <span id="lblfavoritesCount" runat="server"></span></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="qty">
                                                        <div class="qty-btn d-flex">
                                                            <button dataid='<%# Eval("Id")%>' runat="server" onserverclick="btnDeleteCart_ServerClick" data-toggle="tooltip" data-placement="left" title="Eliminar libro del carrito" style="border: none;">
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="cart-summary">
                                ...
                                <ul class="summary-table">
                                    <li><span>subtotal:</span> <span id="lblsubTotal" runat="server"></span></li>
                                    <li><span>delivery:</span> <span>Free</span></li>
                                    <li><span>total:</span> <span id="lblTotal" runat="server"></span></li>
                                </ul>
                                <div class="cart-btn mt-100">
                                    <a href="ConfirmPurchase.aspx" class="btn amado-btn w-100">Continuar</a>
                                </div>
                            </div>
                        </div>
                    </div>
